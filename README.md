...
Python is the main dynamic language used at Kerka. This style guide is a list
...
`pylint`
warnings are each identified by symbolic name (`empty-docstring`)Google-specific warnings start with `g-`.
...
5.  **Deprecated:** application-specific imports that are part of the same
    ...
    You may find older Kerka Python Style code doing this, but it is no longer
